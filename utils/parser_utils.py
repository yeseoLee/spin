...
def filter_argparse_args(args: Union[Namespace, dict], cls: Type, return_dict: bool = False):
    ...
    if "add_argparse_args" in dir(cls):
        ...
        raise RuntimeError(f"Target class {cls} has not valid method for " f"argparse filtering.")
